...
int main() {
    ...
    printf("Welcome to FileSystem. Type 'help' or commands.\n");
    printf("New Command: stressTest\n");
    ...
    while (1) {
        ...
        if (strcmp(cmd, "useradd") == 0) {
            ...
            else printf("Usage: chmod <file> <octal>\n");
        }
        ...
        // -------------------
            ...
            else printf("Usage: open <name> <flag 1=create>\n");
        }
